...
const Assets = {
	...
	BOOST_TEAM_SPEED: gh('media/drawings/boost-your-teams-speed.png'),
    FINISH_PROJECTS: gh('media/drawings/finish-unfinished-projects.png'),
    HANDLE_TEDIOUS_STUFF: gh('media/drawings/handle-the-tedious-stuff.png'),
    EXTRA_HANDS_NEW_PROJECT: gh('media/drawings/extra-hands-for-new-projects.png'),
    FLEXIBLE_FREELANCE_HELP: gh('media/drawings/flexible-freelance-help.png'),
    FINISH_HALF_BUILT_APP: gh('media/drawings/finish-half-built-apps.png'),
    DEBUGGING_OPTIMIZATION: gh('media/drawings/debugging-and-optimization.png'),
    FUTURE_PROOF_CODEBASE: gh('media/drawings/future-proof-your-codebase.png'),
    SCALE_PROJECTS: gh('media/drawings/scale-your-projects.png'),
    COMPLEX_INTEGRATIONS: gh('media/drawings/complex-integrations.png'),
	
	CHATBOT_DEVELOPMENT: gh('media/drawings/chatbot-development.png'),
    MACHINE_LEARNING_MODELS: gh('media/drawings/machine-learning-models.png'),
    AI_CONSULTING: gh('media/drawings/ai-consulting.png'),
    COMPUTER_VISION: gh('media/drawings/computer-vision.png'),
    NATURAL_LANGUAGE_PROCESSING: gh('media/drawings/natural-language-processing.png'),
	FULL_STACK_DEV: gh('media/drawings/full-stack-dev.png'),
    MOBILE_DEV: gh('media/drawings/mobile-dev.png'),
    DB_ADMIN: gh('media/drawings/db-admin.png'),
    SERVER_ADMIN: gh('media/drawings/server-admin.png'),
    HOSTING: gh('media/drawings/hosting.png'),
	INTELLIGENT_AUTOMATION: gh('media/drawings/intelligent-automation.png'),
	AI_BUSINESS_INTELLIGENCE: gh('media/drawings/ai-business-intelligence.png'),
	WORKFLOW_OPTIMIZATION: gh('media/drawings/workflow-optimization.png'),
	PREDICTIVE_ANALYTICS: gh('media/drawings/predictive-analytics.png'),
	CUSTOM_AI_SOLUTIONS: gh('media/drawings/custom-ai.png')
};
